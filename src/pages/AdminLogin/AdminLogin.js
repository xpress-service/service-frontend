...
const AdminLogin = () => {
    ...
    return(
      ...
      <div className="background">
        ...
        <Typography  style={{marginBottom:"20px", textAlign:"center", fontWeight:"bold"}}> SIGNIN </Typography>
          ...
          />
            <Box
                ...
                <Button onClick={formik.handleSubmit} type="submit"  style={{backgroundColor:'#FFB03A', color:'#fff', borderRadius:'20px', textTransform:'none'}} fullWidth>
            Login
          </Button>
          <div className="flex justify-start items-end mt-4">
            ...
            <div className="flex items-center justify-center">
              <p className="text-sm font-medium text-amber-600 hover:text-amber-200 cursor-pointer"  
              onClick={() => {
              setRole("user")
            ...
            <div className="flex items-center">
              <button onClick={() => navigate("/user-reg")} className="group relative w-full flex justify-center py-2 px-4 border rounded-3xl border-transparent text-sm font-medium  text-white bg-stone-800 hover:bg-stone-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-300">
                Create account
              </button>
            </div>
            </form>
