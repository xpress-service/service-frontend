		...
		<UserLayout>
			<div className="flex  flex-shrink-0 w-full md:container md:mx-auto bg-[#F4F4F4] border rounded-3xl py-8 mt-5 gap-5 px-4">
				<div className="flex flex-col gap-3 w-[250px]">
					<FaUser size={150} />
					<p className="flex flex-shrink-0 w-[189px] h-[26px] text-[#262626] text-xl font-bold">
						Gabriel Tosin
					</p>
					<p className="flex flex-shrink-0 w-[153px] h-[32px] text-[#FF9B05] text-xl">
						SX8674584
					</p>
					<p className="flex flex-shrink-0 w-[189px] h-[26px] text-[#262626] text-xl">
						Joined: 25/10/2023
					</p>
				</div>
				...
				<div>
					...
					<div className="flex flex-row w-[800px] justify-between">
						<div className="flex flex-col gap-5">
							<p className="flex flex-shrink-0 w-[90px] h-[26px] text-[#262626] font-normal mt-2">
								Email:
							</p>
							<p className="flex flex-shrink-0 w-[233px] h-[26px] text-[#262626] font-medium">
								tosin@gmail.com
							</p>
							<p className="flex flex-shrink-0 w-[90px] h-[26px] text-[#129B35] font-normal">
								verified
							</p>
							<p className="flex flex-shrink-0 w-[90px] h-[26px] text-[#262626] font-normal mt-5">
								Birthday
							</p>
							<p className="flex flex-shrink-0 w-[90px] h-[26px] text-[#262626] font-normal">
								21/01/1999
							</p>
						</div>
						<div className="flex flex-col gap-5">
							...
							<p className="flex flex-shrink-0 w-[233px] h-[26px] text-[#35539F] font-normal">
								Change Password
							</p>
							<p className="flex flex-shrink-0 w-[90px] h-[26px] text-[#262626] font-normal mt-5">
								Location
							</p>
							<p className="flex flex-shrink-0 w-[233px] h-[26px] text-[#262626] font-normal">
								lagos, Nigeria{" "}
								<span>
									<svg
										xmlns="http://www.w3.org/2000/svg"
						...
						<div className="flex flex-col gap-5 mr-32">
							<p className="flex flex-shrink-0 w-[130px] h-[26px] text-[#262626] font-normal">
								mobibe number
							</p>
							<p className="flex flex-shrink-0 w-[90px] h-[26px] text-[#262626] font-normal">
								xxxxxxxxxxxx
							...
							<p className="flex flex-shrink-0 w-[90px] h-[26px] text-[#262626] font-normal mt-12">
								Gender
							</p>
							<p className="flex flex-shrink-0 w-[90px] h-[26px] text-[#262626] font-normal">
								Male
			...
			<div className="flex flex-col flex-shrink-0 w-full md:container md:mx-auto bg-[#F4F4F4] border rounded-3xl py-8 mt-5 gap-5">
				<table className="border border-seperate min-w-full bg-white border-spacing-4 h-[112px]">
					<tbody>
						<tr className="flex flex-shrink-0 font-bold text-md ml-11">
							Your Order Summary
						</tr>
						...
						<tr className="border border-seperate border-spacing-4">
							<td className="px-4 py-2 bg-white text-left text-xs leading-4 font-medium text-black  tracking-wider mb-1">
								<span className="flex flex-row gap-5">
									<FaUser size={24} /> Order 1
								</span>
								<td className="flex ml-11 mt-[-5px]">
							...
							<td className="px-4 py-2 bg-white text-left  text-xs leading-4 font-medium text-black  tracking-wider">
								...
								>
									<path
										d="M25.5859 19.0676C25.2486 19.0677 24.9146 19.0014 24.603 18.8724C24.2914 18.7435 24.0082 18.5544 23.7696 18.316C23.5311 18.0776 23.3418 17.7945 23.2127 17.483C23.0835 17.1714 23.017 16.8375 23.0168 16.5002C23.0167 16.1629 23.0831 15.829 23.212 15.5173C23.341 15.2057 23.5301 14.9225 23.7685 14.684C24.0069 14.4454 24.2899 14.2561 24.6015 14.127C24.913 13.9978 25.247 13.9313 25.5842 13.9312C26.2654 13.9309 26.9187 14.2013 27.4005 14.6828C27.8823 15.1643 28.1531 15.8174 28.1533 16.4986C28.1535 17.1797 27.8831 17.833 27.4017 18.3148C26.9202 18.7966 26.267 19.0674 25.5859 19.0676Z"
										fill="#777777"
									/>
									<path
										d="M16.7715 19.0674C18.1894 19.0674 19.3389 17.918 19.3389 16.5C19.3389 15.0821 18.1894 13.9326 16.7715 13.9326C15.3536 13.9326 14.2041 15.0821 14.2041 16.5C14.2041 17.918 15.3536 19.0674 16.7715 19.0674Z"
										fill="#777777"
									/>
									<path
										d="M7.95558 19.0674C9.37352 19.0674 10.523 17.918 10.523 16.5C10.523 15.0821 9.37352 13.9326 7.95558 13.9326C6.53765 13.9326 5.38818 15.0821 5.38818 16.5C5.38818 17.918 6.53765 19.0674 7.95558 19.0674Z"
										fill="#777777"
									/>
								</svg>
							</td>
				...
				<div className="flex items-center justify-end mr-3">
					<button className="bg-[#FF9B05] border rounded-3xl w-[135px] h-[44px] text-white">
						View more
					</button>
				</div>
			</div>
