				...
				<div className="bg-[#F4F4F4] shadow-md rounded-2xl overflow-hidden">
					<div className="flex justify-between mb-4">
						<div>
							...
							<h3 className="font-bold text-dark text-xs mx-10">
								Transaction History
							</h3>
						</div>
					...
					<div className="flex justify-between mb-4">
						...
						<div className="mx-10">
							<div className="text-dark font-medium text-xs">
								February 10 - February 21
							</div>
							<button className="text-red-500 font-bold text-xs mx-9">
								Clear All
							</button>
						</div>
					</div>
					...
					<table className="border border-seperate min-w-full bg-white border-spacing-4">
						<thead>
							<tr className="border border-seperate border-spacing-2 bg-white">
								...
								<th className="px-4 py-2 bg-white text-center text-xs leading-4 font-medium text-black uppercase tracking-wider"></th>
							</tr>
						</thead>
						<tbody>
							<tr className="border border-seperate border-spacing-4">
								...
								<td className="px-4 py-2 bg-white text-center  text-xs leading-4 font-medium text-black  tracking-wider">
									N10,000
								</td>
								<td>
									<button>....</button>
